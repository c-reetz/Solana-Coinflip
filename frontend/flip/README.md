...
[API routes](https://nextjs.org/docs/api-routes/introduction) can be accessed on [http://localhost:3000/api/vrf](http://localhost:3000/api/vrf). This endpoint can be edited in `pages/api/vrf.ts`.
