...
import { NonceAccount, NONCE_ACCOUNT_LENGTH, SystemProgram, } from "@solana/web3.js";
import assert from "assert";
import crypto from "crypto";
export function getNoncePubkeyFromSeed(oracleAccount, authority, baseSeed) {
    ...
    const derivedPubkey = anchor.utils.publicKey.createWithSeedSync(authority, seedHashString, SystemProgram.programId);
    return [derivedPubkey, seedHashString];
}
export function nonceAccountExists(accountInfo) {
...
export async function getOracleHeartbeatNonceAccount(oracleAccount, authority) {
...
export async function getOracleStakeUnwrapNonceAccount(oracleAccount, authority) {
...
export async function getOracleNonceQueueAccounts(oracleAccount, authority, queueSize = 1000) {
...
export async function getOracleNonceAccounts(oracleAccount) {
...
export function decodeNonceAccount(info) {
    if (info === null) {
