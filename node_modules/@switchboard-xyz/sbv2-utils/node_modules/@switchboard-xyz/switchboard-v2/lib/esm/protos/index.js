...
export const OracleJob = $root.OracleJob = (() => {
    ...
    OracleJob.decode = function decode(reader, length) {
        ...
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob();
    ...
    OracleJob.HttpTask = (function() {
        ...
        HttpTask.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.HttpTask();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        HttpTask.verify = function verify(message) {
            ...
            if (message.headers != null && message.hasOwnProperty("headers")) {
                ...
                for (let i = 0; i < message.headers.length; ++i) {
                    let error = $root.OracleJob.HttpTask.Header.verify(message.headers[i]);
                    if (error)
        ...
        HttpTask.Header = (function() {
            ...
            Header.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.HttpTask.Header();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
    ...
    OracleJob.JsonParseTask = (function() {
        ...
        JsonParseTask.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.JsonParseTask();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    OracleJob.MedianTask = (function() {
        ...
        MedianTask.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.MedianTask();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    OracleJob.MeanTask = (function() {
        ...
        MeanTask.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.MeanTask();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    OracleJob.MaxTask = (function() {
        ...
        MaxTask.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.MaxTask();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    OracleJob.ValueTask = (function() {
        ...
        ValueTask.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.ValueTask();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    OracleJob.WebsocketTask = (function() {
        ...
        WebsocketTask.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.WebsocketTask();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    OracleJob.ConditionalTask = (function() {
        ...
        ConditionalTask.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.ConditionalTask();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    OracleJob.DivideTask = (function() {
        ...
        DivideTask.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.DivideTask();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    OracleJob.MultiplyTask = (function() {
        ...
        MultiplyTask.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.MultiplyTask();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    OracleJob.AddTask = (function() {
        ...
        AddTask.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.AddTask();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    OracleJob.SubtractTask = (function() {
        ...
        SubtractTask.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.SubtractTask();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    OracleJob.LpTokenPriceTask = (function() {
        ...
        LpTokenPriceTask.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.LpTokenPriceTask();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    OracleJob.LpExchangeRateTask = (function() {
        ...
        LpExchangeRateTask.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.LpExchangeRateTask();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    OracleJob.RegexExtractTask = (function() {
        ...
        RegexExtractTask.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.RegexExtractTask();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    OracleJob.XStepPriceTask = (function() {
        ...
        XStepPriceTask.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.XStepPriceTask();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    OracleJob.TwapTask = (function() {
        ...
        TwapTask.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.TwapTask();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        TwapTask.verify = function verify(message) {
            ...
            if (message.endingUnixTimestampTask != null && message.hasOwnProperty("endingUnixTimestampTask")) {
                let error = $root.OracleJob.CronParseTask.verify(message.endingUnixTimestampTask);
                if (error)
    ...
    OracleJob.SerumSwapTask = (function() {
        ...
        SerumSwapTask.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.SerumSwapTask();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    OracleJob.PowTask = (function() {
        ...
        PowTask.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.PowTask();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    OracleJob.LendingRateTask = (function() {
        ...
        LendingRateTask.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.LendingRateTask();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    OracleJob.MangoPerpMarketTask = (function() {
        ...
        MangoPerpMarketTask.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.MangoPerpMarketTask();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    OracleJob.JupiterSwapTask = (function() {
        ...
        JupiterSwapTask.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.JupiterSwapTask();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    OracleJob.PerpMarketTask = (function() {
        ...
        PerpMarketTask.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.PerpMarketTask();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    OracleJob.OracleTask = (function() {
        ...
        OracleTask.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.OracleTask();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    OracleJob.AnchorFetchTask = (function() {
        ...
        AnchorFetchTask.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.AnchorFetchTask();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    OracleJob.TpsTask = (function() {
        ...
        TpsTask.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.TpsTask();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                default:
    ...
    OracleJob.SplStakePoolTask = (function() {
        ...
        SplStakePoolTask.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.SplStakePoolTask();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    OracleJob.SplTokenParseTask = (function() {
        ...
        SplTokenParseTask.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.SplTokenParseTask();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    OracleJob.DefiKingdomsTask = (function() {
        ...
        DefiKingdomsTask.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.DefiKingdomsTask();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        DefiKingdomsTask.verify = function verify(message) {
            ...
            if (message.inToken != null && message.hasOwnProperty("inToken")) {
                let error = $root.OracleJob.DefiKingdomsTask.Token.verify(message.inToken);
                if (error)
                    return "inToken." + error;
            }
            if (message.outToken != null && message.hasOwnProperty("outToken")) {
                let error = $root.OracleJob.DefiKingdomsTask.Token.verify(message.outToken);
                if (error)
        ...
        DefiKingdomsTask.Token = (function() {
            ...
            Token.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.DefiKingdomsTask.Token();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
    ...
    OracleJob.UniswapExchangeRateTask = (function() {
        ...
        UniswapExchangeRateTask.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.UniswapExchangeRateTask();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    OracleJob.SushiswapExchangeRateTask = (function() {
        ...
        SushiswapExchangeRateTask.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.SushiswapExchangeRateTask();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    OracleJob.PancakeswapExchangeRateTask = (function() {
        ...
        PancakeswapExchangeRateTask.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.PancakeswapExchangeRateTask();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    OracleJob.CacheTask = (function() {
        ...
        CacheTask.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.CacheTask();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        CacheTask.verify = function verify(message) {
            ...
            if (message.cacheItems != null && message.hasOwnProperty("cacheItems")) {
                ...
                for (let i = 0; i < message.cacheItems.length; ++i) {
                    let error = $root.OracleJob.CacheTask.CacheItem.verify(message.cacheItems[i]);
                    if (error)
        ...
        CacheTask.CacheItem = (function() {
            ...
            CacheItem.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.CacheTask.CacheItem();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
    ...
    OracleJob.SysclockOffsetTask = (function() {
        ...
        SysclockOffsetTask.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.SysclockOffsetTask();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                default:
    ...
    OracleJob.MarinadeStateTask = (function() {
        ...
        MarinadeStateTask.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.MarinadeStateTask();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                default:
    ...
    OracleJob.SolanaAccountDataFetchTask = (function() {
        ...
        SolanaAccountDataFetchTask.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.SolanaAccountDataFetchTask();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    OracleJob.CronParseTask = (function() {
        ...
        CronParseTask.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.CronParseTask();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    OracleJob.BufferLayoutParseTask = (function() {
        ...
        BufferLayoutParseTask.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.BufferLayoutParseTask();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    OracleJob.Task = (function() {
        ...
        Task.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.OracleJob.Task();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        Task.verify = function verify(message) {
            ...
            if (message.jsonParseTask != null && message.hasOwnProperty("jsonParseTask")) {
                ...
                properties.Task = 1;
                {
                    let error = $root.OracleJob.JsonParseTask.verify(message.jsonParseTask);
                    if (error)
            ...
            if (message.websocketTask != null && message.hasOwnProperty("websocketTask")) {
                ...
                properties.Task = 1;
                {
                    let error = $root.OracleJob.WebsocketTask.verify(message.websocketTask);
                    if (error)
            ...
            if (message.lpTokenPriceTask != null && message.hasOwnProperty("lpTokenPriceTask")) {
                ...
                properties.Task = 1;
                {
                    let error = $root.OracleJob.LpTokenPriceTask.verify(message.lpTokenPriceTask);
                    if (error)
            ...
            if (message.lpExchangeRateTask != null && message.hasOwnProperty("lpExchangeRateTask")) {
                ...
                properties.Task = 1;
                {
                    let error = $root.OracleJob.LpExchangeRateTask.verify(message.lpExchangeRateTask);
                    if (error)
            ...
            if (message.conditionalTask != null && message.hasOwnProperty("conditionalTask")) {
                ...
                properties.Task = 1;
                {
                    let error = $root.OracleJob.ConditionalTask.verify(message.conditionalTask);
                    if (error)
            ...
            if (message.regexExtractTask != null && message.hasOwnProperty("regexExtractTask")) {
                ...
                properties.Task = 1;
                {
                    let error = $root.OracleJob.RegexExtractTask.verify(message.regexExtractTask);
                    if (error)
            ...
            if (message.xstepPriceTask != null && message.hasOwnProperty("xstepPriceTask")) {
                ...
                properties.Task = 1;
                {
                    let error = $root.OracleJob.XStepPriceTask.verify(message.xstepPriceTask);
                    if (error)
            ...
            if (message.serumSwapTask != null && message.hasOwnProperty("serumSwapTask")) {
                ...
                properties.Task = 1;
                {
                    let error = $root.OracleJob.SerumSwapTask.verify(message.serumSwapTask);
                    if (error)
            ...
            if (message.lendingRateTask != null && message.hasOwnProperty("lendingRateTask")) {
                ...
                properties.Task = 1;
                {
                    let error = $root.OracleJob.LendingRateTask.verify(message.lendingRateTask);
                    if (error)
            ...
            if (message.mangoPerpMarketTask != null && message.hasOwnProperty("mangoPerpMarketTask")) {
                ...
                properties.Task = 1;
                {
                    let error = $root.OracleJob.MangoPerpMarketTask.verify(message.mangoPerpMarketTask);
                    if (error)
            ...
            if (message.jupiterSwapTask != null && message.hasOwnProperty("jupiterSwapTask")) {
                ...
                properties.Task = 1;
                {
                    let error = $root.OracleJob.JupiterSwapTask.verify(message.jupiterSwapTask);
                    if (error)
            ...
            if (message.perpMarketTask != null && message.hasOwnProperty("perpMarketTask")) {
                ...
                properties.Task = 1;
                {
                    let error = $root.OracleJob.PerpMarketTask.verify(message.perpMarketTask);
                    if (error)
            ...
            if (message.anchorFetchTask != null && message.hasOwnProperty("anchorFetchTask")) {
                ...
                properties.Task = 1;
                {
                    let error = $root.OracleJob.AnchorFetchTask.verify(message.anchorFetchTask);
                    if (error)
            ...
            if (message.defiKingdomsTask != null && message.hasOwnProperty("defiKingdomsTask")) {
                ...
                properties.Task = 1;
                {
                    let error = $root.OracleJob.DefiKingdomsTask.verify(message.defiKingdomsTask);
                    if (error)
            ...
            if (message.splStakePoolTask != null && message.hasOwnProperty("splStakePoolTask")) {
                ...
                properties.Task = 1;
                {
                    let error = $root.OracleJob.SplStakePoolTask.verify(message.splStakePoolTask);
                    if (error)
            ...
            if (message.splTokenParseTask != null && message.hasOwnProperty("splTokenParseTask")) {
                ...
                properties.Task = 1;
                {
                    let error = $root.OracleJob.SplTokenParseTask.verify(message.splTokenParseTask);
                    if (error)
            ...
            if (message.uniswapExchangeRateTask != null && message.hasOwnProperty("uniswapExchangeRateTask")) {
                ...
                properties.Task = 1;
                {
                    let error = $root.OracleJob.UniswapExchangeRateTask.verify(message.uniswapExchangeRateTask);
                    if (error)
            ...
            if (message.sushiswapExchangeRateTask != null && message.hasOwnProperty("sushiswapExchangeRateTask")) {
                ...
                properties.Task = 1;
                {
                    let error = $root.OracleJob.SushiswapExchangeRateTask.verify(message.sushiswapExchangeRateTask);
                    if (error)
            ...
            if (message.pancakeswapExchangeRateTask != null && message.hasOwnProperty("pancakeswapExchangeRateTask")) {
                ...
                properties.Task = 1;
                {
                    let error = $root.OracleJob.PancakeswapExchangeRateTask.verify(message.pancakeswapExchangeRateTask);
                    if (error)
            ...
            if (message.sysclockOffsetTask != null && message.hasOwnProperty("sysclockOffsetTask")) {
                ...
                properties.Task = 1;
                {
                    let error = $root.OracleJob.SysclockOffsetTask.verify(message.sysclockOffsetTask);
                    if (error)
            ...
            if (message.marinadeStateTask != null && message.hasOwnProperty("marinadeStateTask")) {
                ...
                properties.Task = 1;
                {
                    let error = $root.OracleJob.MarinadeStateTask.verify(message.marinadeStateTask);
                    if (error)
            ...
            if (message.solanaAccountDataFetchTask != null && message.hasOwnProperty("solanaAccountDataFetchTask")) {
                ...
                properties.Task = 1;
                {
                    let error = $root.OracleJob.SolanaAccountDataFetchTask.verify(message.solanaAccountDataFetchTask);
                    if (error)
            ...
            if (message.bufferLayoutParseTask != null && message.hasOwnProperty("bufferLayoutParseTask")) {
                ...
                properties.Task = 1;
                {
                    let error = $root.OracleJob.BufferLayoutParseTask.verify(message.bufferLayoutParseTask);
                    if (error)
            ...
            if (message.cronParseTask != null && message.hasOwnProperty("cronParseTask")) {
                ...
                properties.Task = 1;
                {
                    let error = $root.OracleJob.CronParseTask.verify(message.cronParseTask);
                    if (error)
