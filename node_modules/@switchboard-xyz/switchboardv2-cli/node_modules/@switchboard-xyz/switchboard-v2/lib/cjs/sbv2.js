...
const index_js_1 = __importDefault(require("./protos/index.js"));
/**
...
const findAccountName = (program, accountInfo) => {
...
exports.findAccountName = findAccountName;
function watchSwitchboardAccount(program, publicKey, accountName, callback) {
...
exports.watchSwitchboardAccount = watchSwitchboardAccount;
/**
...
class ProgramStateAccount {
    ...
    static async create(program, params) {
        ...
        if (params.mint === undefined) {
            ...
            const tokenVault = await spl.createAccount(program.provider.connection, payerKeypair, mint, web3_js_1.Keypair.generate().publicKey);
...
class AggregatorAccount {
    ...
    produceJobsHash(jobs) {
        ...
        for (const job of jobs) {
            ...
            jobHasher.update(index_js_1.default.OracleJob.encodeDelimited(job).finish());
    ...
    async loadJobs(aggregator) {
        ...
        const jobs = jobAccountDatas.map((item) => {
            ...
            return index_js_1.default.OracleJob.decodeDelimited(decoded.data);
        });
        return jobs;
    }
...
class JobAccount {
    ...
    async loadJob() {
        ...
        return index_js_1.default.OracleJob.decodeDelimited(job.data);
    }
    /**
    ...
    static decodeJob(program, accountInfo) {
        return index_js_1.default.OracleJob.decodeDelimited(JobAccount.decode(program, accountInfo).data);
    }
}
...
class PermissionAccount {
    ...
    async setVoterWeightTx(params) {
        ...
        const [addinState, _] = await web3_js_1.PublicKey.findProgramAddress([Buffer.from("state")], params.addinProgram.programId);
...
class OracleQueueAccount {
    ...
    async loadData() {
        ...
        if (!("mint" in queue) ||
            ...
            queue.mint === web3_js_1.PublicKey.default) {
...
class CrankAccount {
    ...
    async popTxn(params) {
        ...
        const payerKeypair = programWallet(this.program);
        let mint = queue.mint;
        if (!mint || mint.equals(web3_js_1.PublicKey.default)) {
    ...
    async pop(params) {
        const payerKeypair = programWallet(this.program);
        return (0, web3_js_1.sendAndConfirmTransaction)(this.program.provider.connection, await this.popTxn(params), [payerKeypair]);
    }
    /**
...
class OracleAccount {
    ...
    async heartbeat(authority) {
        ...
        (0, assert_1.default)(this.publicKey !== undefined);
        (0, assert_1.default)(payerKeypair.publicKey !== undefined);
        (0, assert_1.default)(oracle.tokenAccount !== undefined);
        (0, assert_1.default)(lastPubkey !== undefined);
        (0, assert_1.default)(queueAccount.publicKey !== undefined);
        (0, assert_1.default)(queueAccount.publicKey !== undefined);
        (0, assert_1.default)(permissionAccount.publicKey !== undefined);
        (0, assert_1.default)(queue.dataBuffer !== undefined);
        return this.program.methods
            .oracleHeartbeat({
            permissionBump,
        })
...
class BufferRelayerAccount {
    ...
    async openRound() {
        ...
        const connection = this.program.provider
            .connection;
        return (0, web3_js_1.sendAndConfirmTransaction)(connection, tx, [
