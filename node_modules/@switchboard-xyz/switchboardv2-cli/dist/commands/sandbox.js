...
class SandboxCommand extends BaseCommand_1.default {
    async run() {
        ...
        const parseAddress = new web3_js_1.PublicKey("DpoK8Zz69APV9ntjuY9C4LZCxANYMV56M2cbXEdkjxME");
        console.log(`parseAddress: [${Uint8Array.from(parseAddress.toBuffer())}]`);
        const accountInfo = await this.program.provider.connection.getAccountInfo(parseAddress);
        const byteArray = Uint8Array.from(accountInfo.data);
...
SandboxCommand.description = "sandbox";
