...
class AggregatorLock extends BaseCommand_1.default {
    ...
    async run() {
        ...
        if (this.silent) {
            ...
            this.logger.log(`${chalk_1.default.green(`${utils_1.CHECK_ICON}Aggregator locked successfully\r\n`)}`);
...
exports.default = AggregatorLock;
AggregatorLock.description = "lock an aggregator's configuration and prevent further changes";
AggregatorLock.flags = {
