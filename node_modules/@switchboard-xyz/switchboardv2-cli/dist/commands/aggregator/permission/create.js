...
class AggregatorPermissionCreate extends BaseCommand_1.default {
    async run() {
        ...
        try {
            [permissionAccount] = switchboard_v2_1.PermissionAccount.fromSeed(this.program, queue.authority, queueAccount.publicKey, aggregatorAccount.publicKey);
        ...
        if (this.silent) {
            ...
            this.logger.log(await (0, sbv2_utils_1.prettyPrintPermissions)(permissionAccount));
        }
    }
    async catch(error) {
...
exports.default = AggregatorPermissionCreate;
AggregatorPermissionCreate.description = "create a permission account for an aggregator";
AggregatorPermissionCreate.flags = {
    ...BaseCommand_1.default.flags,
};
AggregatorPermissionCreate.args = [
    {
        name: "aggregatorKey",
